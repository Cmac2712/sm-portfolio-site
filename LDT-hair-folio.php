...
<body>
    ...
    <div class="dk-box-4">
        <div class="bg-image bg-image-parallax">
            <img src="assets/images/LDT-Hair-Folio1.png" class="jarallax-img" alt="">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 text-center">
                    <h1 class="display-3 text-white">Lyndsay Dawn Tait Hair</h1>
                    <p class="lead text-white mb-0">Branding and stationery for Glasgow based hair stylist Lyndsay Dawn Tait Hair.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container mnb-8">
            <div class="row justify-content-between vertical-gap mnt-35">
                <div class="col-12 col-md-6 col-lg-4">
                    <p class="pb-20 mb-0">Lyndsay-Dawn is a Glasgow based hair stylist who specialises in creative colours and edgy cuts.</p>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    <p class="pb-20 mb-0">It was important that her distinctive style came through in her branding and I used sharp fonts and bright distressed textures to achieve this.</p>
                </div>
                <div class="col-12 col-lg-3">
                    <ul class="dk-list">
                        <li><strong>Client:</strong>Lyndsay Dawn Tait Hair</li>
                        <li><strong>Date:</strong> February 2017</li>
                        <li><strong>Services:</strong> <a href="#">Branding</a>, <a href="#">Graphic Design</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="dk-box-2 dk-padding-bot">
        <div class="container">
            <div class="row vertical-gap dk-gallery">
                <div class="col-sm-6">
                    <a href="assets/images/LDT-Hair-Folio2.png" class="dk-gallery-item"><img src="assets/images/LDT-Hair-Folio2.png" alt=""></a>
                </div>
                <div class="col-sm-6">
                    <a href="assets/images/LDT-Hair-Folio3.png" class="dk-gallery-item"><img src="assets/images/LDT-Hair-Folio3.png" alt=""></a>
                </div>
            </div>
        </div>
    </div>
