...
<head>
    ...
    <title>Sam MacIntyre | Disney Kitchen Toddler</title>
        ...
        <div class="container mnb-8">
            <div class="row justify-content-between vertical-gap mnt-35">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <p class="pb-20 mb-0">The Disney Kitchen (DK) brand is currently being rolled out across all Disney’s UK food products as they reposition themselves as a more health conscious option for parents.  The majority of DK products are co-branded with the brand trust for consumers coming from the co-brand.</p><p class="mb-0">As our range is solely DK, we had to consider the whole brand experience that Disney Kitchen could provide, creating the "Toddler Promise" and "Always Tasty" promise to build trust with parents and included more consumer friendly call outs on packaging.</p>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
				...
				<div class="col-12">
					...
					<div style="display:none;" id="video1">
						<video class="lg-video-object lg-html5" controls preload="none">
							<source src="./assets/video/sizzle2.mp4" type="video/mp4">
