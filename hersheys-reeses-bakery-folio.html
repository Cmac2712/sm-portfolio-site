...
<head>
    ...
    <title>Sam MacIntyre | Hershey's & Reese's Bakery</title>
...
<body>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 text-center">
                    ...
                    <p class="lead text-white mb-0">I manage the design of all packaging, POS and other sales support material for the Hershey's & Reese's US bakery range.  I also manage all approvals with the Hershey Company.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container mnb-8">
            <div class="row justify-content-between vertical-gap mnt-35">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <p class="pb-20 mb-0">Lightbody Ventures hold The Hershey Company license for bakery in North America.  The range covers a variety of products including muffins, dessert cakes and cookies.</p><p class="mb-0">My responsibilities include visualisation of new product concepts, designing all product labelling to brand guidelines and creating sales support material.</p>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    <p class="pb-20 mb-0">I also manage all packaging approvals for these products which involves working with colleagues in the UK and USA to produce final artwork and manage expectations and any complications with The Hershey Company.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="dk-pagination">
        <div class="container">
            <a href="disney-kitchen-folio.html" class="dk-pagination-prev justify-content-start"><span class="dk-pagination-icon"><span class="icon pe-7s-angle-left"></span></span>Previous Project</a>
            ...
            <a href="reeses-rounds-folio.html" class="dk-pagination-next justify-content-end">
