...
<head>
    ...
    <title>Sam MacIntyre | Reese's Rounds</title>
...
<body>
            ...
            <div class="row justify-content-between vertical-gap mnt-35">
                <div class="col-12 col-lg-3">
                    <ul class="dk-list">
                        ...
                        <li><strong>Date</strong><br>June 2018</li>
                        <li><strong>Key Responsibilities</strong><br>Logo Development<br>Concept Visualisation<br>Packaging Design<br>Sales Support Material<br>Photography<br>Licensor Approvals</li>
                    </ul>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    <p class="pb-20 mb-0">Lightbody Ventures (LBV) launched Reese's Rounds under license back in October 2016, extending the Reese's brand into the UK biscuit market.  Reese's Rounds were the first biscuit to be launched in the UK using real peanut butter so we were sure to call out this USP on pack.</p><p class="mb-0">I created the "Rounds" sub-logo and designed the packaging to brand guidelines.  Packaging approvals with the Hershey Company were also managed through me.</p>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    <p class="pb-20 mb-0">In 2018 the biscuit was redeveloped, changing from a vanilla biscuit base to a cocoa base.  This was the perfect time for a packaging refresh and as with the 2016 launch I managed the design and licensor approval of all packaging and sales support material.</p><p class="mb-0">I also managed product photography, from styling the biscuits and taking the inital images to re-touching and composing the final image for packaging.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="dk-pagination">
        <div class="container">
            <a href="hersheys-reeses-bakery-folio.html" class="dk-pagination-prev justify-content-start"><span class="dk-pagination-icon"><span class="icon pe-7s-angle-left"></span></span>Previous Project</a>
            ...
            <a href="stacy-hannah-folio.html" class="dk-pagination-next justify-content-end">
