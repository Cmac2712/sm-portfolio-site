...
<a href="disney-kitchen-folio.html" class="dk-portfolio-item dk-portfolio-item-style-1 dk-portfolio-item-center dk-portfolio-item-dark">
    ...
    <span class="dk-portfolio-item-info">
        <span class="h3 dk-portfolio-item-title">Disney Kitchen Toddler</span>
...
<a href="hersheys-reeses-bakery-folio.html" class="dk-portfolio-item dk-portfolio-item-style-1 dk-portfolio-item-center dk-portfolio-item-dark">
    ...
    <span class="dk-portfolio-item-info">
        <span class="h3 dk-portfolio-item-title">Hershey's & Reese's Bakery</span>
    ...
    <span class="dk-portfolio-item-info">
        ...
        <!--<span class="dk-portfolio-item-category">
            ...
            <!-- <div class="dk-box-2">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <h2>We create products that make people happy.</h2>
                        </div>
                        <div class="col-lg-6">
                            <p class="lead">Firmament first without, in it also lesser brought. Can't green from firmament unto shall i. Beginning living together light blessed sixth place behold without make had upon for dry, made rule Second. Given one won't us said open divided night the life.</p>
                            <p class="lead mb-0">Own won't said every gathered herb third replenish face seas days moved. Form over rule light created they're.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="dk-box-1">
                <div class="bg-image bg-pattern">
                    <div style="background-color: #202020; background-image: url(assets/images/bg-pattern.png);"></div>
                </div>
                <div class="container">
                    <div class="row mnt-40 mnb-5 justify-content-center vertical-gap">
                        
                        <div class="col-12 col-sm-6 col-lg-3">
                            
        <div class="dk-feature-1">
            <div class="dk-feature-cont">
                <div class="dk-feature-icon">
                    <span class="icon pe-7s-arc"></span>
                </div>
                <div class="dk-feature-title">Creative Ideas</div>
                <div class="dk-feature-text">Be set fourth land god darkness  make it wherein own</div>
            </div>
        </div>
        ...
        <div class="dk-feature-1">
            <div class="dk-feature-cont">
                ...
                <div class="dk-feature-title">Realy clean code</div>
                <div class="dk-feature-text">A she&#39;d them bring void moving  third she&#39;d kind fill</div>
            </div>
        </div>
        ...
        <div class="dk-feature-1">
            <div class="dk-feature-cont">
                ...
                <div class="dk-feature-title">Support 24/7</div>
                <div class="dk-feature-text">Dominion man second spirit he, earth they&#39;re creeping</div>
            </div>
        </div>
        ...
        <div class="dk-feature-1">
            <div class="dk-feature-cont">
                ...
                <div class="dk-feature-title">Talanted team</div>
                <div class="dk-feature-text">Morning his saying moveth it  multiply appear life be</div>
            </div>
        </div>
                                ...
                                <div class="col-lg-9">
                                    <div class="dk-reviews">
                                        ...
                                        <div class="dk-reviews-text">
                                            <p class="mb-0">Outstanding job and exceeded all expectations. It was a pleasure to work with them on a sizable first project and am looking forward to start the next one asap.</p>
                                        </div>
                                        <div class="dk-reviews-name">Oliver Osborne</div>
                                    </div>
                                </div>
                            </div>
                        </div>
