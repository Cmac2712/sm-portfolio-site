...
<head>
    ...
    <title>Sam MacIntyre | A Love Story</title>
...
<body>
    ...
    <div class="dk-box-4">
        <div class="bg-image bg-image-parallax">
            <img src="assets/images/A-Love-Story-Folio1.png" class="jarallax-img" alt="">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 text-center">
                    <h1 class="display-3 text-white">A Love Story</h1>
                    <p class="lead text-white mb-0">My wedding became a bit of a branding affair!</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container mnb-8">
            <div class="row justify-content-between vertical-gap mnt-35">
                <div class="col-12 col-lg-3">
                    <ul class="dk-list">
                        <li><strong>Client</strong><br>Personal</li>
                        <li><strong>Date</strong><br>July 2018</li>
                        <li><strong>Key Responsibilities</strong><br>Personal Branding<br>Hand-Made Invitations</li>
                    </ul>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    <p class="pb-20 mb-0">Being a designer who spends her life immersed in brand identities, I was a bit more particular than most about everything matching for my wedding.  From the invitations to the flip flop hangers, everything followed the same visual identity!</p>
                </div>
                <div class="col-12 col-md-6 col-lg-4">
                    <p class="pb-20 mb-0">Inspired by old Penguin books for our handmade invitations, I kept the theme running through every element I made.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="dk-box-2 dk-padding-bot">
        <div class="container">
            <div class="row vertical-gap dk-gallery">
                <div class="col-sm-6">
                    <a href="assets/images/A-Love-Story-Folio2.png" class="dk-gallery-item"><img src="assets/images/A-Love-Story-Folio2.png" alt=""></a>
                </div>
                <div class="col-sm-6">
                    <a href="assets/images/A-Love-Story-Folio3.png" class="dk-gallery-item"><img src="assets/images/A-Love-Story-Folio3.png" alt=""></a>
                </div>
                <div class="col-sm-6">
                    <a href="assets/images/A-Love-Story-Folio4.png" class="dk-gallery-item"><img src="assets/images/A-Love-Story-Folio4.png" alt=""></a>
                </div>
                <div class="col-sm-6">
                    <a href="assets/images/A-Love-Story-Folio5.png" class="dk-gallery-item"><img src="assets/images/A-Love-Story-Folio5.png" alt=""></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <a href="stacy-hannah-folio.html" class="dk-pagination-prev justify-content-start"><span class="dk-pagination-icon"><span class="icon pe-7s-angle-left"></span></span>Previous Project</a>
            ...
            <a href="chairmans-ruin-folio.html" class="dk-pagination-next justify-content-end">
