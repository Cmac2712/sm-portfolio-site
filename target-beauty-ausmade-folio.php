            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6 text-center">
                        <h1 class="display-3 text-white">Target Beauty<br>Australian Made</h1>
                        <p class="lead text-white mb-0">Introducing a premium range of beauty packaging for Target Australia that celebrates native botanical ingredients.</p>
                    </div>
                </div>
            </div>
        </div>
