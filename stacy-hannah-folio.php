        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 text-center">
                    <h1 class="display-3 text-dark-2 font-400">Stacy Hannah Chocolate</h1>
                    <p class="text-dark mb-0">Branding & illustration for luxury Scottish chocolatier Stacy Hannah Chocolates.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="dk-box-2 pb-16 pt-0">
        <div class="container">
            <div class="row vertical-gap dk-gallery">
                <div class="col-sm-6">
                    <a href="assets/images/Stacy-Hannah-Folio3.png" class="dk-gallery-item"><img src="/assets/images/Stacy-Hannah-Folio3.png" alt=""></a>
                </div>
                <div class="col-sm-6">
                    <a href="assets/images/Stacy-Hannah-Folio2.jpg" class="dk-gallery-item"><img src="/assets/images/Stacy-Hannah-Folio2.jpg" alt=""></a>
                </div>
                <div class="col-sm-6">
                    <a href="assets/images/Stacy-Hannah-Folio4.jpg" class="dk-gallery-item"><img src="/assets/images/Stacy-Hannah-Folio4.jpg" alt=""></a>
                </div>
                <div class="col-sm-6">
                    <a href="assets/images/Stacy-Hannah-Folio5.png" class="dk-gallery-item"><img src="/assets/images/Stacy-Hannah-Folio5.png" alt=""></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="dk-box-2 pb-16 pt-0">
        <div class="container mnb-8">
            <div class="row justify-content-start vertical-gap mnt-35">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <p class="pb-20 mb-0">One of the aims of this project was to deliver versatile labelling that could be used across many different pack formats and flavour profiles.  The range has five colour ways to differentiate flavours and I delivered a combination of adhesive labels, cardboard sleeves and inserts that could be used with each of SHC pack types.  Each piece of packaging has a space to either write or place a label of the flavour or collection name and space on the back for an ingredients and allergens label.</p>
                </div>
            </div>
        </div>
    </div>
